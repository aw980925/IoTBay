 ...
 import org.bson.codecs.pojo.PojoCodecProvider;;
   ...
   public class MongoDB {   
       ...
       protected MongoDatabase database;     //MongoDB super-class initializes and shares the MongoDatabase       
              ...
              //This method load the clusters of your database collection in a list

              //Use the correct cluster-string from mongodb atlas     

               private void loadClusters(){       

                       clusters.add("cluster0-shard-00-00-aoxef.mongodb.net:27017");        

                       clusters.add("cluster0-shard-00-01-aoxef.mongodb.net:27017");       

                       clusters.add("cluster0-shard-00-02-aoxef.mongodb.net:27017");   

               }       

 

              //This method initiliazes the mongoClient URI used in the constructor to connect to the MongoDB collection
              ...
              private MongoClientURI mongoClientURI(String owner, String password, String role, String db){       
                       ...
                       MongoClientURI uri = new MongoClientURI( ""+ "mongodb://" + owner + ":" + password + "@"
