...
public void addProduct(int id, int categoryID, String name, double price, String description, String status, int quantity ) throws SQLException { //code for add-operation       
  st.executeUpdate("INSERT INTO PRODUCT " + "VALUES ('" + id + "', '" + categoryID + "', '" + name + "', '" + price + "', '" + description + "', '" + status + "', '" + quantity + "')");   
